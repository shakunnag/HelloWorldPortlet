...
<% 
  ...
  if (preferences != null) {
    String value = (String)preferences.getValue(com.lbg.cbo.HelloWorldPortlet.HelloWorldPortlet.EDIT_DEFAULTS_KEY, "");
%> 
  <FORM ACTION="<portlet:actionURL/>" METHOD="POST">
    <LABEL for="<%=com.lbg.cbo.HelloWorldPortlet.HelloWorldPortlet.EDIT_DEFAULTS_TEXT%>">New Value</LABEL><BR>
    <INPUT name="<%=com.lbg.cbo.HelloWorldPortlet.HelloWorldPortlet.EDIT_DEFAULTS_TEXT%>" value="<%=value%>" type="text"/><BR>
    <INPUT name="<%=com.lbg.cbo.HelloWorldPortlet.HelloWorldPortlet.EDIT_DEFAULTS_SUBMIT%>" value="Save" type="submit"/>
  </FORM>
<%
  } else {
